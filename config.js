...
const config = {
    ...
    botOwner: process.env.BOT_OWNER || 'Ayesha',
    ownerNumber: process.env.OWNER_NUMBER || '923429010160',
    author: process.env.AUTHOR || 'Ayesha',
    packname: process.env.PACKNAME || 'AYESHA-MD',
